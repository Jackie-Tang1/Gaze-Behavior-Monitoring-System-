...
SC_MODULE(repacket3){
  sc_in<int> re_packet3;
  sc_in<int> re_packet6;
  sc_in<int> re_packet9;
  sc_in<int> re_packet12;
  sc_in<int> re_packet15;
  ...
  SC_CTOR(repacket3){
    ...
    sensitive << re_packet3;
    SC_METHOD(prc_repacket2);
    sensitive << re_packet6;
    SC_METHOD(prc_repacket3);
    sensitive << re_packet9;
    SC_METHOD(prc_repacket4);
    sensitive << re_packet12;
    SC_METHOD(prc_repacket5);
    sensitive << re_packet15;
  }
...
SC_MODULE(counter3){
  ...
  //cout <<sc_time_stamp()<<"mobile3"<<tuple_in<<"      "<<packet<<endl;
  }
