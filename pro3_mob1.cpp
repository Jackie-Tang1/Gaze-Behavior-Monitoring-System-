...
SC_MODULE(repacket1){
  sc_in<int> re_packet1;
  sc_in<int> re_packet4;
  sc_in<int> re_packet7;
  sc_in<int> re_packet10;
  sc_in<int> re_packet13;
  ...
  SC_CTOR(repacket1){
    ...
    sensitive << re_packet1;
    SC_METHOD(prc_repacket2);
    sensitive << re_packet4;
    SC_METHOD(prc_repacket3);
    sensitive << re_packet7;
    SC_METHOD(prc_repacket4);
    sensitive << re_packet10;
    SC_METHOD(prc_repacket5);
    sensitive << re_packet13;
  }
...
SC_MODULE(counter1){
  ...
  void prc_counter(){
   ...
   //cout <<sc_time_stamp()<<"mobile1:  "<<tuple_in<<"      "<<packet<<endl;
  }
